...
function Upper({ className }) {

  const [isVisible, setVisible] = useState(true);
  return (
    <div className="relative">
      {isVisible && (<div className={`grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2 w-full px-1 pt-1 ${className || 'h-auto'}`}>
      ...
      <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 z-20 cursor-pointer">
        <button
          onClick={() => setVisible(!isVisible)}
          className=" cursor-pointer bg-white rounded-full p-1 shadow-md border border-gray-200 text-gray-500 hover:text-sky-600 hover:bg-gray-50 transition-all"
        >
