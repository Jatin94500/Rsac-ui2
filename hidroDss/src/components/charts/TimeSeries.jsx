            ...
            <div className="ts-card">
                ...
                <div className="ts-chart-container">
                    <BarChart
                        ...
                        series={[{ data: [10, 8, 15, 25, 40, 90, 180, 160, 100, 40, 12, 8], label: selectedLabel, color: '#3b82f6' }]}
                        height={320}
                        sx={{
                            bgcolor: 'transparent',
                            borderRadius: 2,
                            '& .MuiChartsAxis-tickLabel': { fill: '#64748b', fontSize: '0.75rem' },
                            '& .MuiChartsLegend-label': { fill: '#334155', fontSize: '0.8rem' },
                        }}
                    />
                </div>
            </div>
